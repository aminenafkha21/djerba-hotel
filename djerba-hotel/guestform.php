...
<div class="etapes columns">
		...
		<div class="etapes1 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#e59a09;color:#fff">3</a>
...
<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		...
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  ...
		  <div class="row">
			...
			<div class="large-6 columns">
			  <label class="fontcolor">Telephone Number*
				<input name="phone" type="text" id="phone" value="<?php if(isset($_SESSION['phone']) && !empty($_SESSION['phone'])){echo  $_SESSION['phone'];}?>" pattern= "[^a-zA-Z]+" Title="Only numbers are allowed"  placeholder="+216" size="35"/>
			  </label>
			</div>
		  </div>
		  <div class="row">
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo " style="background-color:#e59a09;color:#fff" onclick="return confirm('Are you sure you want to continue?')" >Confirm</button>
		  </div>
