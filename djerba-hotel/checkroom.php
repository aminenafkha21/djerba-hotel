...
<div class="etapes columns">
		...
		<div class="etapes1 columns centerdiv ">
			<a href="" class="button round fontslabo" style="background-color:#e59a09;color:#fff">2</a>
			<p class="fontgrey1">Select Room</p>
		</div>
		<div class="etapes1 columns centerdiv">
			<a href="checkroom.php" class="button round blackblur fontslabo" >3</a>
...
<div class="row">
	<div class=" large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<div class="etap large-12 columns " >
		<p><b>Your Reservation</b></p><hr class="line">
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<br><button name="submit" href="#" class="button small fontslabo"  style="background-color:#e59a09;color:#fff; width:100%;" >Edit Reservation</button>
					</div>
				  </div>
				</form>
		</div>
		<div class="large-12 columns" id="roomselected" style="display:none;" >
				<hr>
							<br><label for="submit-form" class="book button small fontslabo" style="background-color:#e59a09;color:#fff; width:100%; height:45px; !important;">Proceed To Book</label><!--button name="submit" href="#" class="button small fontslabo" style="background-color:#2ecc71; width:100%;" >Proceed Booking</button-->
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						{ 
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : Dt </span><span style=\"font-size:24px;\">".$sub_row['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : Dt </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
